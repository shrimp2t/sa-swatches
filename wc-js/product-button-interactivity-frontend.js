	...
	(n.n = (e) => {
		...
		(() => {
			...
			const l = window.wp.i18n,
				c = (0, i.forwardRef)(function ({ icon: e, size: t = 24, ...n }, r) {
			...
			function N(e) {
				...
				return {
					...n,
					updateSlot: (0, i.useCallback)(
						(n) => {
							t.updateSlot(e, n);
						},
						[e, t.updateSlot],
					),
					unregisterSlot: (0, i.useCallback)(
						(n) => {
					...
					fills: o,
					registerFill: (0, i.useCallback)(
						(n) => {
							t.registerFill(e, n);
						},
						[e, t.registerFill],
					),
					unregisterFill: (0, i.useCallback)(
						(n) => {
			...
			function k({ name: e, children: t, registerFill: n, unregisterFill: r }) {
				const o = ((e) => {
						const { getSlot: t, subscribe: n } = (0, i.useContext)(F),
							[r, o] = (0, i.useState)(t(e));
						return (
							(0, i.useEffect)(
								() => (
									o(t(e)),
				...
				return (
					...
					(0, i.useLayoutEffect)(() => {
						e !== s.current.name &&
							(r(s.current.name, s.current),
							(s.current.name = e),
							n(e, s.current));
					}, [e]),
					o && o.node
						? ((0, E.isFunction)(t) && (t = t(o.props.fillProps)),
						  (0, i.createPortal)(t, o.node))
						: null
				);
			}
			const M = (e) =>
			...
			class A extends i.Component {
				...
				render() {
					const {
						...
						o = (0, E.map)(r(t, this), (e) => {
							const t = (0, E.isFunction)(e.children)
								? e.children(n)
								: e.children;
			...
			const P = (e) =>
				(0, i.createElement)(
					F.Consumer,
					null,
					({ registerSlot: t, unregisterSlot: n, getFills: r }) =>
						(0, i.createElement)(
							A,
							w({}, e, {
								registerSlot: t,
				...
				return (
					...
					n.ref && n.ref.current
						? ("function" == typeof t && (t = t(n.fillProps)),
						  (0, i.createPortal)(t, n.ref.current))
						: null
				);
			}
			const W = (0, i.forwardRef)(function (
				{ name: e, fillProps: t = {}, as: n = "div", ...r },
				o,
			) {
			...
			function z(e) {
				return (0, i.createElement)(
					i.Fragment,
					null,
					(0, i.createElement)(M, e),
					(0, i.createElement)(V, e),
				);
			}
			const H = (0, i.forwardRef)(({ bubblesVirtually: e, ...t }, n) =>
				e
					? (0, i.createElement)(
							W,
							w({}, t, {
				...
				(
					...
					(o = J || o),
						(0, i.useLayoutEffect)(() => {
							if (J)
								return (
									Y(B.current, "is-without-arrow", o),
									Y(B.current, "is-alternate", s),
									G(B.current, "data-x-axis"),
									G(B.current, "data-y-axis"),
									K(B.current, "top"),
									K(B.current, "left"),
									K(P.current, "maxHeight"),
									void K(P.current, "maxWidth")
								);
							const e = () => {
								...
								let e = (function (e, t, n, r = !1, o, i) {
									...
									if (!1 !== r) {
										if (
											!(r && window.Range && window.Element && window.DOMRect)
										)
											return;
										if (
											"function" == typeof (null == r ? void 0 : r.cloneRange)
										)
											return _(
												(0, L.getRectangleFromRange)(r),
												r.endContainer.ownerDocument,
												i,
											);
										if (
											"function" ==
											typeof (null == r ? void 0 : r.getBoundingClientRect)
										) {
											const e = _(
								...
								if (!e) return;
								const { offsetParent: t, ownerDocument: n } = B.current;
								let r,
									i = 0;
								if (t && t !== n.body) {
								...
								O &&
									(r =
										null === (c = B.current.closest(".popover-slot")) ||
										void 0 === c
											? void 0
											: c.parentNode);
								const u = Z.height ? Z : P.current.getBoundingClientRect(),
									{
										...
										const [u, d = "center", m] = n.split(" "),
											p = (function (e, t, n, r, o, i, s, a) {
												const { height: l } = t;
												if (o) {
												...
												const u = {
													...
													m = {
														popoverTop: e.bottom,
														contentHeight:
															e.bottom + 10 + l > window.innerHeight
												...
												let p,
													...
													h = null;
												if (!o && !a)
													if ("middle" === n && u.contentHeight === l)
														f = "middle";
													else if ("top" === n && d.contentHeight === l)
														f = "top";
													else if ("bottom" === n && m.contentHeight === l)
														f = "bottom";
													else {
														f =
															d.contentHeight > m.contentHeight
																...
																: "bottom";
														const e =
															"top" === f ? d.contentHeight : m.contentHeight;
														h = e !== l ? e : null;
													}
												return (
													(p =
											...
											f = (function (e, t, n, r, o, i, s, a, c) {
												const { width: u } = t;
												"left" === n && (0, l.isRTL)()
													? (n = "right")
													: "right" === n && (0, l.isRTL)() && (n = "left"),
													"left" === r && (0, l.isRTL)()
														? (r = "right")
														: "right" === r && (0, l.isRTL)() && (r = "left");
												const d = Math.round(e.left + e.width / 2),
													m = {
														popoverLeft: d,
														contentWidth:
															(d - u / 2 > 0 ? u / 2 : d) +
															(d + u / 2 > window.innerWidth
																? window.innerWidth - d
																: u / 2),
													};
												let p = e.left;
												...
												let w,
													...
													b = null;
												if (!o && !a)
													if ("center" === n && m.contentWidth === u)
														v = "center";
													else if ("left" === n && h.contentWidth === u)
														v = "left";
													else if ("right" === n && g.contentWidth === u)
														v = "right";
													else {
														v =
															h.contentWidth > g.contentWidth
																? "left"
																: "right";
														const e =
															"left" === v ? h.contentWidth : g.contentWidth;
														u > window.innerWidth && (b = window.innerWidth),
															e !== u &&
																((v = "center"),
																(m.popoverLeft = window.innerWidth / 2));
													}
												if (
													((w =
														"center" === v
													...
													(w = Math.min(w, e.right - u)),
														(0, l.isRTL)() || (w = Math.max(w, 0));
												}
												return {
													xAxis: v,
													popoverLeft: w,
								...
								"number" == typeof h &&
									"number" == typeof g &&
									(K(B.current, "top", h + "px"),
									K(B.current, "left", g + "px")),
									Y(
										B.current,
										"is-without-arrow",
										o || ("center" === w && "middle" === v),
									...
									Y(B.current, "is-alternate", s),
									G(B.current, "data-x-axis", w),
									G(B.current, "data-y-axis", v),
									K(
										P.current,
										"maxHeight",
							...
							e();
							const { ownerDocument: t } = B.current,
								{ defaultView: n } = t,
							...
							return (
								u &&
									u !== t &&
									(u.defaultView.addEventListener("resize", e),
									u.defaultView.addEventListener("scroll", e, !0)),
								T &&
									((h = new n.MutationObserver(e)),
									h.observe(T, {
										attributes: !0,
									})),
								() => {
									n.clearInterval(r),
										...
										u &&
											u !== t &&
											(u.defaultView.removeEventListener("resize", e),
											u.defaultView.removeEventListener("scroll", e, !0)),
										h && h.disconnect();
								}
							);
						}, [J, p, f, d, m, a, Z, y, T, O]);
					const $ = (e, n) => {
						...
						re =
							...
							(function (e) {
								if ("loading" === e.type)
									return b()("components-animate__loading");
								const { type: t, origin: n = U(t) } = e;
								if ("appear" === t) {
								...
								return "slide-in" === t
									? b()("components-animate__slide-in", "is-from-" + n)
									: void 0;
							})({
								type: "appear",
								origin: W,
							});
					let oe = (0, i.createElement)(
						"div",
						w(
							{
			...
			X.Slot = (0, i.forwardRef)(function ({ name: e = j }, t) {
			...
			const J = X,
				Q = function ({ shortcut: e, className: t }) {
					if (!e) return null;
					let n, r;
					return (
						(0, E.isString)(e) && (n = e),
						(0, E.isObject)(e) && ((n = e.display), (r = e.ariaLabel)),
						(0, i.createElement)(
							"span",
							{
								className: t,
				...
				$ = ({ eventHandlers: e, child: t, childrenWithPopover: n }) =>
					(0, i.cloneElement)(
						(0, i.createElement)(
							"span",
							{
				...
				ee = ({ child: e, eventHandlers: t, childrenWithPopover: n }) =>
					(0, i.cloneElement)(e, {
						...t,
						children: n,
					}),
				...
				ne = function ({ children: e, position: t, text: n, shortcut: r }) {
					const [o, s] = (0, i.useState)(!1),
						[a, l] = (0, i.useState)(!1),
						c = (0, C.useDebounce)(l, 700),
						u = (t) => {
							te(e, "onMouseDown", t),
						...
						m = (e) => ("mouseUp" === e ? d : "mouseDown" === e ? u : void 0),
						p = m("mouseUp"),
						f = (t, n) => (r) => {
					...
					if (((0, i.useEffect)(() => h, []), 1 !== i.Children.count(e)))
						return e;
					const g = {
				...
				re = function ({ icon: e, className: t, ...n }) {
					const r = ["dashicon", "dashicons", "dashicons-" + e, t]
						.filter(Boolean)
						.join(" ");
					return (0, i.createElement)(
						"span",
				...
				oe = function ({ icon: e = null, size: t = 24, ...n }) {
					if ("string" == typeof e)
						return (0, i.createElement)(
							re,
							w(
					...
					if ((0, i.isValidElement)(e) && re === e.type)
						return (0, i.cloneElement)(e, {
							...n,
						});
					if ("function" == typeof e)
						return e.prototype instanceof i.Component
							? (0, i.createElement)(e, {
									size: t,
									...n,
							  })
				...
				ae = (0, i.forwardRef)(function (e, t) {
					const {
							...
							var l, c, u, d, m;
							return (
								t && ((null !== (l = a) && void 0 !== l) || (a = "primary")),
								r && ((null !== (c = a) && void 0 !== c) || (a = "tertiary")),
								n && ((null !== (u = a) && void 0 !== u) || (a = "secondary")),
								e &&
									(S()("Button isDefault prop", {
										since: "5.4",
										alternative: 'variant="secondary"',
									}),
									(null !== (d = a) && void 0 !== d) || (a = "secondary")),
								o && ((null !== (m = a) && void 0 !== m) || (a = "link")),
								{
									...s,
									variant: a,
								}
					...
					const N =
							...
							((f && v) ||
								g ||
								(!!v && (!y || ((0, E.isArray)(y) && !y.length)) && !1 !== f)),
						...
						M = (0, i.createElement)(
							...
							d &&
								"left" === m &&
								(0, i.createElement)(oe, {
									icon: d,
									size: p,
								}),
							C && (0, i.createElement)(i.Fragment, null, C),
							d &&
								"right" === m &&
								(0, i.createElement)(oe, {
									icon: d,
			...
			const pe = ".wc-block-store-notices",
				...
				{ state: ge } = (0, t.store)("woocommerce/product-button", {
					state: {
						get slideInAnimation() {
							const { animationStatus: e } = he();
						...
						get numberOfItemsInTheCart() {
							const { productId: e } = he(),
								t = ((e, t) =>
									null == e ? void 0 : e.items.find((e) => e.id === t))(
									ge.cart,
									e,
								);
						...
						get addToCartText() {
							const e = he();
							return e.animationStatus === me.IDLE ||
								e.animationStatus === me.SLIDE_OUT
								? fe(
										e.addToCartText,
										ge.inTheCartText,
										e.temporaryNumberOfItems,
								  )
								: fe(
										e.addToCartText,
										ge.inTheCartText,
										ge.numberOfItemsInTheCart,
								  );
						},
						get displayViewCart() {
							const { displayViewCart: e, temporaryNumberOfItems: t } = he();
							return (
								!!e &&
								(ge.hasCartLoaded ? ge.numberOfItemsInTheCart > 0 : t > 0)
							);
						},
					},
					actions: {
						*addToCart() {
							const t = he(),
								{ productId: n, quantityToAdd: s } = t;
							t.isLoading = !0;
							try {
								yield (0, r.dispatch)(o.CART_STORE_KEY).addItemToCart(n, s),
									(t.temporaryNumberOfItems = ge.numberOfItemsInTheCart);
							} catch (t) {
						...
						handleAnimationEnd: (e) => {
							...
							"slideOut" === e.animationName
								? (t.animationStatus = me.SLIDE_IN)
								: "slideIn" === e.animationName &&
								  ((t.temporaryNumberOfItems = ge.numberOfItemsInTheCart),
								  (t.animationStatus = me.IDLE));
						},
					},
					callbacks: {
						syncTemporaryNumberOfItemsOnLoad: () => {
							const e = he();
							ge.hasCartLoaded &&
								(e.temporaryNumberOfItems = ge.numberOfItemsInTheCart);
						},
						startAnimation: () => {
							const e = he();
							ge.hasCartLoaded &&
			...
			(0, r.subscribe)(() => {
				...
				(0, r.select)(o.CART_STORE_KEY).hasFinishedResolution("getCartData") &&
					(ge.cart = e);
			}, o.CART_STORE_KEY),
